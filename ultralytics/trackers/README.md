...
model = YOLO("path/to/25.2.9.pt")  # Load a custom trained model
...
yolo track model=path/to/25.2.9.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/25.2.9.pt tracker="bytetrack.yaml"
```
